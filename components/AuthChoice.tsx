    ...
    <div className="max-w-md mx-auto py-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="flex flex-col gap-4 px-4">
        ...
        <div className="space-y-3">
          <div id="googleSignInButton" className="w-full min-h-[44px]"></div>
          <p className="text-center text-[10px] text-[#a8a29e] font-medium uppercase tracking-widest">— OR —</p>
          <AuthButton 
            ...
            accent="bg-white border-[#8b7e6a] shadow-md border-2"
          />
        </div>
